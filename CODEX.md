...
### Content Integrity
- **`Thesis_V32.docx` is the canonical source of truth.** Path: `/Users/akhil/Library/CloudStorage/OneDrive-Personal/THESIS/CURRENT WRITING/Thesis_V32.docx`. V32 is V31 plus the four substantive author paragraphs (water-main contamination, pre-fire density, architectural lineage, hale framing specs) backfilled on 2026-05-18. V31.docx remains as the as-submitted archive snapshot — do not edit it. **Section bodies on the website should match V32 verbatim.** The 2026-05-18 drift audit (`docs/drift-audit/2026-05-18-v32-vs-website-drift.md`) lists the 77 remaining smaller divergences (glossary expansions, brief notes) that still need either back-port into V32 or removal from the website. Workflow: edit V32 first → re-extract → propagate to website. Do not edit website prose directly; do not paraphrase or "improve" V32 content. Re-run `python3 scripts/drift_audit.py` after any V32 or website content change.
