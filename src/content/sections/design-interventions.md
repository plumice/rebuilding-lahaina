...
The fire removed Princess Nahienaena Elementary, the civic center, and the commercial core in the same burn event because they occupied the same zone. Concentration produced simultaneous loss. The recovery framework distributes essential functions across multiple sites to prevent recurrence.
