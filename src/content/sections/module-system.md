...
The hipped roof geometry directs rainwater toward central valleys between modules, where aluminum gutters intercept and channel runoff. A custom Y-shaped column connector at valley gutters merges structural and drainage functions, a modern adaptation not present in traditional hale but essential to the water-harvesting strategy. Subsurface volcanic gravel beds and storage tanks beneath module clusters capture collected water for non-potable reuse.

| Water Performance Metric | Value |
|---|---|
| Roof Catchment Area | 57,460 sq ft |
| Collection Efficiency | 80% |
| Annual Yield | 429,801 gallons |
| Daily Average | ~1,178 gallons |
| Demand Offset | 12-26% |
| Recommended Storage | 160,000-250,000 gallons |

This on-site rainwater harvesting is a regulatory necessity given West Maui's Stage 2 water shortage, which prevents processing of new water meters and restricts irrigation to one day per week. The school's catchment system demonstrates how public architecture can contribute to distributed water infrastructure while meeting its own non-potable needs.
...
|---|---|
| Steep roof pitch (~45 degrees) | Deflects high-angle midday sun |
...
This passive strategy eliminates mechanical cooling requirements under most conditions, aligning the building's operational costs with its resilience goals.

## Assembly: Vernacular Understanding

Joint types echo Hawaiian lashing and plantation-era timber connections, maintaining visible articulation of the structural hierarchy:
...
The kit-of-parts system positions the module as a prototype for housing, shelter, and community anchor construction across Lahaina's recovery: fast deployment through community assembly, off-grid capable, and resilient to future disruptions. Its limitless aggregation potential extends beyond this single school to the broader recovery framework.
