...
| Year | Intermediate (ft/m) | Int.-High (ft/m) | Worst-Case (ft/m) | Impact Analysis |
|---|---|---|---|---|
| 2040 | 0.6 / 0.18 | 0.8 / 0.24 | 1.3 / 0.40 | Onset of chronic flooding; king tides become nuisance events; storm drain backflow begins |
| 2050 | 1.0 / 0.30 | 1.3 / 0.40 | 1.5 / 0.46 | State planning baseline; >100 high-tide flood days annually; near-term certainty window |
| 2060 | 1.5 / 0.46 | 2.0 / 0.61 | 2.5 / 0.76 | Infrastructure threshold; harbor breakwalls overtopped; groundwater impacts Mokuʻula restoration |
| 2080 | 2.5 / 0.76 | 3.5 / 1.07 | 5.0 / 1.52 | Critical inundation; Front Street seawall breached; significant beach loss at Kaʻanapali |
| 2100 | 3.9 / 1.19 | 5.9 / 1.80 | 8.0 / 2.44 | Planning benchmark; 3.2-ft SLR-XA surpassed; Honoapiʻilani Hwy requires realignment |
| 2120 | 4.7 / 1.43 | 7.0 / 2.13 | 12.0+ / 3.66 | Regime shift; historic coastline fully submerged; elevation strategies insufficient |
| 2150 | 6.8 / 2.07 | 9.0 / 2.74 | 19.0+ / 5.79 | Long-term displacement; current urban footprint untenable; shoreline migrates mauka |
| 2300 | 11.9 / 3.63 | 19.0+ / 5.79 | 30.0+ / 9.14 | Geographic alteration; complete coastal reconfiguration; paleo-shoreline restoration |
...
Interception infrastructure is basically just placing linear capture systems at key convergence points where water comes together. This happens where upland runoff meets streets, drainage corridors, and buffer edges. The main point is to filter the water and redirect it into collection ponds or underground cisterns. It is a smart way to handle the flow if you think about it.
