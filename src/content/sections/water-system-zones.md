---
title: "Water System - Zone by Zone"
...
relatedDrawings: ["water-zones-mauka-makai", "water-collection-principles", "buffer-water-collection"]
relatedSources: ["wsp-highway-survey", "stage2-water-shortage", "rainfall-atlas"]
...
The primary way surface water moves through the town is via natural stream paths, mainly Kahoma Stream and Kanahā Stream. Naturalized, they are conveying water from the peri-urban buffer down to the coast. This is where

### Riparian Conveyance

It restores the channel geometry accommodate both baseflow and flood flows (baseflow). A huge part of this is removing the concrete lining that constrains the stream from natural meander. If you think about it, the concrete limits habitat complexity. The modifications follow the principles set in the Greater New Orleans Urban Water Plan. These principles widening floodplain benches wider accommodate high-water events, creating pool-riffle sequences accommodate habitat diversity, and vegetating native species on the banks to erosion control, filter water.
...
The brackish mouth is designed to be a naturalized wetland instead of just an engineered outfall. This is important because it allows for things like sediment deposition and nutrient uptake. It also provides a habitat for transitional species that are adapted to the fluctuating salinity. Plus, there are elevated pathways. These give public access across the discharge zone without disrupting hydrological function. If you look at the mouth geometry, the mouth geometry is sized to handle projected sea-level rise through 2100. There are setbacks so the brackish zone can kind of landward migration as coastal conditions change. Also, vegetated berms at the upstream edge stop salt water from getting into the freshwater riparian corridor during storm surge events. This protecting upstream habitat and water quality.

If you look at the San Sebastián river mouth in Spain, it shows exactly how a brackish mouth zone acts as a transitional area. It is wide than just having a fixed outfall. This is specifically where the Urumea River meets the ocean. The mouth there is wide and adaptive on its own. Since there aren't hard edges, it lets things like tidal exchange and sediment deposition happen naturally. Also, the salinity levels can fluctuate without issues. The way this is built slows the water down before it releases into the ocean, which supports the estuarine ecology a lot. Plus, it reduces upstream pressure during storm events. Basically, it shows that discharge should be treated as a whole process instead of just being an endpoint.

If you applied this to the brackish mouth zone, the goal is to make a wetland condition that naturalized. It supports to filter freshwater before it goes into the ocean. Plus, it can accommodate things such as sea-level rise and tidal changes. By setbacks, the brackish area is allowed to migrate landward over time. These are protecting the upstream riparian corridor from saltwater intrusion. Also, elevated crossings are put in so maintain public access the area. This is good because it disrupts hydrology. It pretty much reinforces the brackish mouth ecological infrastructure while showing a legible urban edge.
